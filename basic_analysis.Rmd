...
**To-do**
* Remove extra lysation samples!!! Some samples got two runs, with two lysate runs
...
dat %>% 
  ...
  group_by(locality, habitat_type) %>% 
  ggplot(.) +
 geom_boxplot(aes(y = Toerrvekt_.g., x = locality, fill = habitat_type), na.rm = T) +
...
IKKE KLAR, gjør bedre fargeskala
