...
liquid_mod_0 <- glmer(no_species ~ liquid * weeks_sampled + (1| sample_id) + (1 | empty_week) + (1 | locality), 
                      family = "poisson",
                      data = liquid_comp)
...
liquid_mod_1 <- glmer(no_species ~ liquid * weeks_sampled + (1 | empty_week) + (1 | locality), 
                      family = "poisson",
                      data = liquid_comp)
